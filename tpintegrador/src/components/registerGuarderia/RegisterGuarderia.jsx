...
const RegisterGuarderia = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (loggedUser.role !== "dueño") {
      setErrorMessage("Solo los dueños pueden registrar guarderías");
      return;
    }
  ...
  return (
    <div className="bodyRegisterGuarderia">
      <form className="cuadradoRegisterGuarderia" onSubmit={handleSubmit}>
        ...
        <div>
          <input
            ...
            placeholder="Ingrese la dirección de la guardería"
            required
          />
        </div>
        <div>
          <label className="label-register-guarderia">
            Seleccion Zona cercana:
          </label>
          <select
            name="area"
            value={area}
            onChange={(e) => setArea(e.target.value)}
            className="select-guarderia"
          >
        ...
        <div className="checkboxes">
          <label>
            <input
              ...
              name="openSpace"
              checked={openSpace}
              onChange={(e) => setOpenSpace(e.target.checked)}
            />{" "}
            Espacio Abierto
          </label>
          <label>
            <input
              ...
              name="walker"
              checked={walker}
              onChange={(e) => setWalker(e.target.checked)}
            />{" "}
            Paseador
          </label>
        </div>
...
export default RegisterGuarderia;
